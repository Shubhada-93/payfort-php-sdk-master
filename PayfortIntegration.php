...
class PayfortIntegration
{
     ...
     */
    public $merchantIdentifier = 'a894b168';
    
    /**
     * @var string your access code
     */
    public $accessCode         = '7leCwrdyaAsT68IaSLbe';
    
    /**
     * @var string SHA Request passphrase
     */
    public $SHARequestPhrase   = '09zIXJLQgiyXALEcgRyeSs)_';
    
    /**
     * @var string SHA Response passphrase
     */
    public $SHAResponsePhrase = '82z5yJZQOSW7zJBz18MIbt!_';
